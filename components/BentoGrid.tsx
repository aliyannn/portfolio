...
export const BentoGrid: React.FC = () => {
  ...
  return (
    <section id="about" className="relative py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-hidden">
      ...
      {/* Unified Balanced Bento Grid Layout */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
        
        {/* Card 1 (lg:col-span-2, row-span-1): Full-Spectrum Engineering */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.5 }}
          className="lg:col-span-2 rounded-2xl bg-zinc-950/80 border border-white/10 p-6 flex flex-col justify-between backdrop-blur-xl shadow-xl hover:border-cyan-500/30 transition-all duration-300 group"
        >
          <div>
        ...
        {/* Card 2 (lg:col-span-1, row-span-2): Core Stack */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.5, delay: 0.1 }}
          className="lg:col-span-1 lg:row-span-2 rounded-2xl bg-zinc-950/80 border border-white/10 p-6 flex flex-col justify-between backdrop-blur-xl shadow-xl hover:border-purple-500/30 transition-all duration-300 group"
        >
          <div>
            <div className="flex items-center justify-between mb-4">
          ...
          <div className="pt-4 border-t border-white/5 text-[11px] font-mono text-zinc-400 flex items-center justify-between">
            <span>Verified Skills</span>
            <span className="text-purple-400 font-semibold">100% Tested</span>
          </div>
        </motion.div>

        {/* Card 3 (lg:col-span-1, row-span-1): Location & Timezone */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.5, delay: 0.2 }}
          className="lg:col-span-1 rounded-2xl bg-zinc-950/80 border border-white/10 p-6 flex flex-col justify-between backdrop-blur-xl shadow-xl hover:border-emerald-500/30 transition-all duration-300 group"
        >
          <div>
          ...
          <div className="pt-3 text-[11px] font-mono text-zinc-400 border-t border-white/5">
            <span>Remote &amp; On-Site Support Ready</span>
          </div>
        </motion.div>

        {/* Card 4 (lg:col-span-1, row-span-1): Engineering Impact & Metrics */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.5, delay: 0.3 }}
          className="lg:col-span-1 rounded-2xl bg-zinc-950/80 border border-white/10 p-6 flex flex-col justify-between backdrop-blur-xl shadow-xl hover:border-amber-500/30 transition-all duration-300 group"
        >
          <div>
            <div className="flex items-center justify-between mb-3">
            ...
            <div className="grid grid-cols-2 gap-2 text-center">
              <div className="p-2.5 rounded-xl bg-zinc-900/60 border border-white/5">
                <span className="text-lg font-extrabold text-amber-400 font-mono block">4+ Yrs</span>
                <span className="text-[10px] font-mono text-zinc-400">Tech Experience</span>
              </div>
              <div className="p-2.5 rounded-xl bg-zinc-900/60 border border-white/5">
                <span className="text-lg font-extrabold text-cyan-400 font-mono block">99.9%</span>
                <span className="text-[10px] font-mono text-zinc-400">System Uptime</span>
              </div>
            </div>
          </div>

          <div className="pt-3 border-t border-white/5 text-[11px] font-mono text-emerald-400 flex items-center gap-1.5 font-medium">
            <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" />
            <span>100% Delivery Track Record</span>
          </div>
        </motion.div>
      </div>
    </section>
