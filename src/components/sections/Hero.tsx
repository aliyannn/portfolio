...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center pt-20 pb-12 overflow-hidden bg-[#030712] transform-gpu">
      ...
      <div className="absolute bottom-1/4 left-1/4 w-[400px] h-[400px] bg-indigo-600/10 rounded-full blur-[150px] pointer-events-none" />

      {/* 3. Hero Responsive Container */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center min-h-[85vh] pt-16 lg:pt-20 pb-8">
          
          {/* Left Column (lg:col-span-7): Text Content */}
          ...
          {/* Right Column (lg:col-span-5): Terminal Container */}
          <motion.div
      ...
      <motion.a
        ...
        className="absolute bottom-3 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 text-zinc-500 hover:text-cyan-400 transition-colors z-20"
      >
        <span className="text-[10px] uppercase font-mono tracking-widest text-zinc-500">Scroll Down</span>
        <div className="w-4 h-7 rounded-full border border-zinc-700/80 p-0.5 flex justify-center backdrop-blur-xs">
